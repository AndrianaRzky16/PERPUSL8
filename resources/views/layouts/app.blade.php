    ...
    <section class="h-100 w-100 bg-white" style="box-sizing: border-box">
        ...
        style="font-family: Poppins, sans-serif">
            ...
            <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
				...
				<li class="nav-item">
					<a class="nav-link px-md-4" href="{{ route('perpusku.students.index') }}">Data Siswa</a>
				</li> 
				<li class="nav-item">
					<a class="nav-link px-md-4" href="{{ route('perpusku.rayons.index') }}">Rayon</a>
				</li>
				<li class="nav-item">
					<a class="nav-link px-md-4" href="{{ route('perpusku.rombel.index') }}">Rombel</a>
				</li>
            </ul>
            <div class="d-flex">
